...
public final class e extends InputConnectionWrapper {
    ...
    public final /* synthetic */ g f6624a;
    ...
    public final boolean performPrivateCommand(java.lang.String r12, android.os.Bundle r13) {
        ...
        L_0x0062:
            ...
            k0.h r10 = new k0.h     // Catch:{ all -> 0x007d }
            r10.<init>(r6, r7, r8)     // Catch:{ all -> 0x007d }
            k0.f r0 = (k0.f) r0     // Catch:{ all -> 0x007d }
            boolean r2 = r0.a(r10, r9, r3)     // Catch:{ all -> 0x007d }
        L_0x0077:
        ...
        L_0x008a:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: k0.e.performPrivateCommand(java.lang.String, android.os.Bundle):boolean");
    }
}

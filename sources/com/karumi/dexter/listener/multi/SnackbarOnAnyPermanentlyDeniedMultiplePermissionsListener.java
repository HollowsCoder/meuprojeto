...
public class SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener extends BaseMultiplePermissionsListener {
    ...
    public static class Builder {
        ...
        public SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener build() {
            return new SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener(this.view, this.text, this.buttonText, this.onClickListener, (Snackbar.a) null, this.duration);
        }
    ...
    private SnackbarOnAnyPermanentlyDeniedMultiplePermissionsListener(View view2, String str, String str2, View.OnClickListener onClickListener, Snackbar.a aVar, int i10) {
        this.view = view2;
        this.text = str;

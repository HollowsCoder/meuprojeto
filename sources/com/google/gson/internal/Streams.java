...
public final class Streams {
    ...
    public static final class a extends Writer {
        ...
        public final Appendable f3828o;

        /* renamed from: p  reason: collision with root package name */
        public final C0044a f3829p = new C0044a();

        /* renamed from: com.google.gson.internal.Streams$a$a  reason: collision with other inner class name */
        public static class C0044a implements CharSequence {

            /* renamed from: o  reason: collision with root package name */
            public char[] f3830o;

            public final char charAt(int i10) {
                return this.f3830o[i10];
            }

            public final int length() {
                return this.f3830o.length;
            }

            public final CharSequence subSequence(int i10, int i11) {
                return new String(this.f3830o, i10, i11 - i10);
            }
        }

        public a(Appendable appendable) {
            this.f3828o = appendable;
        }
        ...
        public final void write(int i10) {
            this.f3828o.append((char) i10);
        }

        public final void write(char[] cArr, int i10, int i11) {
            C0044a aVar = this.f3829p;
            aVar.f3830o = cArr;
            this.f3828o.append(aVar, i10, i11 + i10);
        }
    }

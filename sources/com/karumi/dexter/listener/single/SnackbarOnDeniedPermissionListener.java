...
public class SnackbarOnDeniedPermissionListener extends BasePermissionListener {
    ...
    public static class Builder {
        ...
        public SnackbarOnDeniedPermissionListener build() {
            return new SnackbarOnDeniedPermissionListener(this.view, this.text, this.buttonText, this.onClickListener, (Snackbar.a) null, this.duration);
        }
    ...
    private SnackbarOnDeniedPermissionListener(View view2, String str, String str2, View.OnClickListener onClickListener, Snackbar.a aVar, int i10) {
        this.view = view2;
        this.text = str;
